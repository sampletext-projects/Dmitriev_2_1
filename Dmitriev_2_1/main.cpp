...
public:
	...
	void display()
	{
		cout << "1-я сторона:" << side1 << endl;
		cout << "2-я сторона:" << side2 << endl;
		cout << "3-я сторона:" << side3 << endl;
		cout << "1-й угол:" << angle1 << endl;
		cout << "2-й угол:" << angle2 << endl;
		cout << "3-й угол:" << angle3 << endl;
	}
};
...
int main()
{
	...
	cout << "На какое число изменить данную сторону треугольника?" << endl;
	double delta;
	cin >> delta;
